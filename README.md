...
<h3 id="windows_soft">Windows 软件篇</h3>

> 很多人都是用 windows 平台的，所以推荐一些 windows 的软件。

- [Wox](http://www.getwox.com/) - **免费**，快捷键 alt+ 空格，这个软件配合固态硬盘操作打开软件，集成文件搜索，翻译，颜色，书签等多款插件；键盘比鼠标快详见《卓有成效的程序员》
- [Zeal](https://zealdocs.org/) - **免费**，windows 下的 Dash ，不但可以离线管理文档，还可以自己制作文档，这样的话就不用一个一个的打开 api 了
